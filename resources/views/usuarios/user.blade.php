            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    <span class="badge text-bg-primary mb-3">
                        Bienvenid@ {{ Auth::user()->nombre ?? ($user->nombre ?? 'Usuario') }} - Vista de usuario
                    </span>
                    <h1 class="display-6 fw-bold mb-3">Panel de solicitudes.</h1>
                    <p class="lead text-secondary mb-0">
                        Espacio limitado para consultar servicios, registrar solicitudes y revisar el estado de
                        seguimiento.
                    </p>
                </div>
                <div class="col-lg-4">
                    <div class="quick-panel">
                        <div class="card-body p-4">
                            ...
                            <div class="d-grid gap-2">
                                <a href="{{ url('/vista/servicios') }}" class="btn btn-outline-primary">Ver
                                    servicios</a>
                                <a href="{{ url('/vista/solicitudes/nueva') }}" class="btn btn-primary">Nueva
                                    solicitud</a>
                                <a href="{{ url('/vista/solicitudes') }}" class="btn btn-outline-secondary">Ver
                                    solicitudes</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center g-4">
                        <div class="col-lg-8">
                            ...
                            <p class="text-secondary mb-0">
                                Esta vista separa el flujo del usuario final del panel administrativo. Desde aqui se
                                consultan servicios y se gestionan solicitudes.
                            </p>
                        </div>
                        <div class="col-lg-4">
                            <div class="d-grid gap-2">
                                <a class="btn btn-primary btn-lg" href="{{ url('/vista/servicios') }}">Ver
                                    servicios</a>
                                <a class="btn btn-outline-primary btn-lg" href="{{ url('/vista/solicitudes') }}">Abrir
                                    solicitudes</a>
                            </div>
                        </div>
                    </div>
