...
<body>
    <nav class="navbar navbar-expand-lg bg-white border-bottom sticky-top">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#consultoriasNav"
                aria-controls="consultoriasNav" aria-expanded="false" aria-label="Abrir navegacion">
                            ...
                            <tbody>
                                @forelse($consultorias as $consultoria)
                                    <tr>
                                        ...
                                        <td>{{ $consultoria->descripcion ?? 'Sin descripcion' }}</td>
                                        <td class="text-end">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-secondary py-4">No hay consultorias
                                            registradas todavia.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
